...
def train_behavioral_cloning(expert_data_path: str, epochs: int = 50, save_path: str = "models/bc/human_bc_tuned.pth"):
...
def bc_then_gail(expert_data_path: str):
    ...
    bc_model_path = "models/bc/human_bc_tuned.pth"
    print("=" * 60)
...
if __name__ == "__main__":
    bc_then_gail("data/expert_data/human_demos.pkl")